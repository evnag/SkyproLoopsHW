public class Main {
    public static void main(String[] args) {
         ...
         */
        {
            int fistFridayInMonth = 1;
            while (fistFridayInMonth <= 31) {
                System.out.println("Сегодня пятница, " + fistFridayInMonth + "-е число. Необходимо подготовить отчет.");
                fistFridayInMonth += 7;
            }
        }
        ...
        будет увидеть. Для начала нам нужно посчитать траекторию движения кометы, которая пролетает рядом с Землей каждый
